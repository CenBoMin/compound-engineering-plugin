...
此仓库构建的插件 _面向_ 开发者。从最终用户（使用插件的开发者）而非本仓库贡献者的角度对解决方案进行分类。

- **`developer-experience/`** — 影响 _本仓库_ 贡献的问题：本地开发设置、shell 别名、测试 ergonomics、CI 摩擦。如果修复只影响拥有本仓库 checkout 的人，则属于此处。
